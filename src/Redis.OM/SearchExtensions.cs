...
namespace Redis.OM
{
    ...
    public static class SearchExtensions
    {
        ...
        public static IRedisCollection<T> NearestNeighbors<T, TKnnType>(this IRedisCollection<T> source, Expression<Func<T, TKnnType>> expression, int numNeighbors, TKnnType item)
            where T : notnull
        {
            var collection = (RedisCollection<T>)source;
