...
{
    /// <summary>
    /// An indexed vector embedding, can be whatever type you want so long as you provide a serializer.
    /// </summary>
    public class VectorAttribute : SearchFieldAttribute
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the Vector dimension specified as a positive integer. Will be inferred from the vectorizer
        /// if provided.
        /// </summary>
        ...
        /// <inheritdoc/>
        internal override SearchFieldType SearchFieldType => SearchFieldType.VECTOR;
