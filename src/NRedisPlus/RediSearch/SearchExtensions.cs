...
namespace NRedisPlus.RediSearch
{
    ...
    public static class SearchExtensions
    {
        ...
        public static RedisCollection<T> Where<T>(this RedisCollection<T> source, Expression<Func<T, bool>> expression)
            where T : notnull
        {
            var exp = Expression.Call(
                   null,
        ...
        public static RedisCollection<TR> Select<T, TR>(this RedisCollection<T> source, Expression<Func<T, TR>> expression)
            where T : notnull
            where TR : notnull
        {
            var exp = Expression.Call(
        ...
        public static RedisCollection<T> Skip<T>(this RedisCollection<T> source, int count)
            where T : notnull
        {
            var exp = Expression.Call(
                null,
        ...
        public static RedisCollection<T> Take<T>(this RedisCollection<T> source, int count)
            where T : notnull
        {
            var exp = Expression.Call(
                null,
        ...
        public static RedisCollection<T> GeoFilter<T>(this RedisCollection<T> source, Expression<Func<T, GeoLoc?>> expression, double lon, double lat, double radius, GeoLocDistanceUnit unit)
            where T : notnull
        {
            var exp = Expression.Call(
                null,
