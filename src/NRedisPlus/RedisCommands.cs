...
namespace NRedisPlus
{
    public static class RedisCommands
    {
        ...
        public static SortedSetEntry[] ZDiffWithScores(this IRedisConnection connection, params string[] keys)
        {
            ...
            return connection.Execute("ZDIFF", args);            
        }
        ...
        public static SortedSetEntry[] ZPopMax(this IRedisConnection connection, string key, int count) => connection.Execute("ZPOPMAX", key, count.ToString());

        public static SortedSetEntry[] ZPopMin(this IRedisConnection connection, string key, int count) => connection.Execute("ZPOPMIN", key, count.ToString());

        public static SortedSetEntry[] ZRandMemberWithScores(this IRedisConnection connection, string key, int count) => connection.Execute("RANDMEMBER", key, count.ToString(), "WITHSCORES");
        ...
        public static SortedSetEntry[] ZRevRangeWithScores(this IRedisConnection connection, string key, int start, int stop) => connection.Execute("ZREVRANGE", key, start.ToString(), stop.ToString(), "WITHSCORES");
